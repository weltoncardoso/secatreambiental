...
class Noticias extends model {
	...
	public function inserir($titulo, $descricao, $texto) {

		$sql = "INSERT INTO noticias SET titulo = '$titulo', descricao = '$descricao', texto = '$texto', date_noticia = NOW()";
		$this->db->query($sql);	
	...
	public function updateNoticia($id, $titulo, $descricao, $texto) {

		$sql = "UPDATE noticias SET titulo = '$titulo', descricao = '$descricao', texto = '$texto' WHERE id = '$id'";
		$this->db->query($sql);		
	...
	public function removerNoticia($id) {
		...
		if($sql->rowCount() > 0) {
			...
			$this->db->query("DELETE FROM noticias_img WHERE id = '$id'");
		}

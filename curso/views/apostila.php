...
<body>
    ...
    <p align="center">Para efetuar o pagamento de sua apostila impressa, basta apenas clicar no botão abaixo.</p>
    <div align="center">
<!-- INICIO FORMULARIO BOTAO PAGSEGURO -->
<form action="https://pagseguro.uol.com.br/checkout/v2/payment.html" method="post" onsubmit="PagSeguroLightbox(this); return false;">
<!-- NÃO EDITE OS COMANDOS DAS LINHAS ABAIXO -->
<input type="hidden" name="code" value="2B351E83A2A292A22410AF93D5B4C6DD" />
...
<!-- FINAL FORMULARIO BOTAO PAGSEGURO -->
   ...
   <p align="center">Ao efetuar o pagamento de sua apostila,</br> envie o comprovante para nosso email a fim de Agilizarmos o envio!</p>
<br />

<header>
<div class="whatsapp" style="font-size:16px">
  <i class="fab fa-whatsapp"></i> <span>61</span> 99984-7102
</div>

<nav class="navbar navbar-expand-lg navbar-dark bg-nav" style="height:120px; font-size:16px">
  <div class="container-fluid">
    <a href="<?php echo BASE; ?>" style="margin-top:-50px;" class="navbar-brand h1 mb-0"><img src="<?php echo BASE; ?>assets/img/logo.png" alt=""></a>

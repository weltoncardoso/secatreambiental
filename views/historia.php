  ...
  <body>
    ...
    <section class="about-page py-5 my-5">
      <div class="container">
        ...
        <p class="mt-4">Pioneira tamb&eacute;m em gest&atilde;o de res&iacute;duos s&oacute;lidos e em res&iacute;duos de servi&ccedil;os de sa&uacute;de,  a Secatre vem desenvolvendo cursos sobre o tema procurando sensibilizar a comunidade para a preserva&ccedil;&atilde;o ambiental, destacando-se como primeira empresa do Distrito Federal a atuar na &aacute;rea de res&iacute;duos de sa&uacute;de. Uma m&eacute;da de mil alunos multiprofissionais e oriundos de diversos estados brasileiros, Amap&aacute;, Roraima, Par&aacute;, Maranh&atilde;o, Piau&iacute;, Cear&aacute;, Para&iacute;ba, Pernambuco, Alagoas, Sergipe, Bahia, Minas Gerais, Espirito Santo, Mato Grosso, Mato Grosso do Sul, Goi&aacute;s, Distrito Federal, Rio de Janeiro, S&atilde;o Paulo e Paran&aacute; j&aacute; passaram pelos cursos da Secatre, atuando como multiplicadores no Pa&iacute;s para o desenvolvimento dos Planos de Gerenciamento de Res&iacute;duos S&oacute;lidos e Plano de Gerenciamento de Res&iacute;duos de Servi&ccedil;os de Sa&uacute;de. </p>

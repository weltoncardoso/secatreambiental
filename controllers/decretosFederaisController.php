...
class decretosFederaisController extends controller
{
	...
	public function index() {
      ...
      $dados = array();
        ...
        $dados['total_decretos_federais'] = $lei->getTotalDecretosFederais();


        $dados['pdfs'] = $lei->getPdfs($offset, $limit);
        $dados['decretosfederais'] = $lei->getDecretosFederais($offset, $limit);

		$this->loadTemplate('decretosFederais', $dados);
